...
%% sensor0 parameter and actuator 0
use2ndFcn=1; % select 2nd order (1) or 8th order (0) transfer function

min = 3; %lower measurement limit
max = 5; %upper measurement limit
...
usenoise = 1; %select noise or not (0=no noise, 1=use noise) for sensor
useideal = 0; %select ideal sensor or not (0=non-ideal, 1=ideal) for sensor
useidealac = 0; %select ideal actuator or not (0=non-ideal, 1=ideal) for sensor
