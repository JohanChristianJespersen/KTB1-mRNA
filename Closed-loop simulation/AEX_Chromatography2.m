function [sys,x0,str,ts,simStateCompliance] = AEX_Chromatography2(t,x,u,flag,gridsize)
...
par = struct(...
    ...
    'epsbed',  0.35,...                             % no unit
    'epspar',  0.8,...                              % no unit
    'rad', 170E-6,...                               % 17um converteret til [dm]
    'keff',  [0.0200, 0.0107, 0.0107],...           % from cm/s converted to [dm/h] 
   ...
     'ads', [3.6E-10, 3.6E-7, 0.30],...              % Langmuir adsorption coefficient [dm^3/g/h]
     'des', [1.44E-13, 3.6E-10, 0.60],...           % Langmuir desorption coefficient [1/h]
     'qmax', [1.44E-6, 1.02E-6, 3.6]);              % Langmuir maximum concentration [g/dm^3]
